Holder for two sets of code that I use a fair bit in my own Godot programming, so I thought I'd make them addons in case anyone else wants to make use of them.
